 ...
 * Documentación visual del módulo RF004
 */
...
export function FlujoRevisionAprobacion({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 rounded-full bg-white/20 hover:bg-black/10 transition-colors z-10"
        >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-100">
                    RF004 - Control de calidad jurídica
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="p-6 border-2 border-green-200">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">¿Qué es RF004?</h3>
            ...
            <div className="relative">
              ...
              <div className="space-y-6">
                {ETAPAS_FLUJO.map((etapa, index) => (
                  ...
                  >
                    <Card
                      className={`p-6 border-2 hover:shadow-xl transition-all ml-0 md:ml-14 ${etapa.numero === 5 ? 'ring-2 ring-green-400 ring-offset-2' : ''
                        }`}
              ...
              <div className="flex-1">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3 p-3 bg-white rounded-lg border border-blue-200">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900">Envía a revisión RF004</p>
                      <p className="text-xs text-gray-600">
          ...
          <Card className="p-4 bg-gray-50 border border-gray-200">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-gray-700">
                ...
                <p>
                  RF004 garantiza que todos los documentos jurídicos que emite la OCID sean correctos antes de
