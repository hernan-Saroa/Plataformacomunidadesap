        ...
        <div className="px-6 py-5 space-y-5">
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="bg-white rounded-lg p-3 border border-red-200 shadow-sm">
                  <p className="font-bold text-gray-900">{proceso.consecutivo}</p>
                  <p className="text-sm text-gray-700">{proceso.disciplinable.nombre}</p>
                  <p className="text-xs text-gray-500">{proceso.disciplinable.identificacion}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 mb-2">
              Para confirmar, escribe el consecutivo del proceso: <span className="font-mono font-semibold text-gray-900">{proceso.consecutivo}</span>
            </p>
            <input
              type="text"
            ...
            {confirmacionTexto && confirmacionTexto !== proceso.consecutivo && (
              <p className="text-xs text-red-600 mt-1.5">❌ El consecutivo no coincide</p>
            )}
            {confirmacionTexto === proceso.consecutivo && (
              <p className="text-xs text-green-600 mt-1.5">✅ Consecutivo confirmado</p>
            )}
          </div>
