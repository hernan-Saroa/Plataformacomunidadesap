...
import { LayoutGrid, Users, FileText, Mail, Bell, ClipboardList } from 'lucide-react';
...
type TabActiva = 'ESTADOS_KANBAN' | 'CARGOS' | 'PLANTILLAS_AUTOS' | 'PLANTILLAS_OFICIOS' | 'PLANTILLAS_ACTAS' | 'ENTIDADES' | 'NOTIFICACIONES';
