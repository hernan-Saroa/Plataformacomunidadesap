        ...
        <div className="p-6 space-y-5">
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="p-3 rounded-lg border-2" style={{ background: '#FFFFFF', borderColor: '#FECACA' }}>
                  <p className="font-bold" style={{ color: '#1F2937' }}>{noticia.numeroRadicado}</p>
                  <p className="text-sm" style={{ color: '#6B7280' }}>{noticia.denunciado.nombre}</p>
                  <p className="text-xs" style={{ color: '#9CA3AF' }}>{noticia.denunciado.identificacion}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-xs mb-2" style={{ color: '#6B7280' }}>
              Para confirmar, escribe el número de radicado: <span className="font-mono font-semibold" style={{ color: '#1F2937' }}>{noticia.numeroRadicado}</span>
            </p>
            <input
              type="text"
