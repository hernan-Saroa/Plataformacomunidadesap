 ...
 * Modal para agregar/eliminar plantillas de un tipo de oficio
 */
...
export function ModalGestionarPlantillasOficio({ tipoOficio, onGuardar, onCerrar }: ModalGestionarPlantillasOficioProps) {
  const [plantillas, setPlantillas] = useState<PlantillaArchivo[]>(tipoOficio.plantillas || []);
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            <div>
              ...
              <p className="text-sm text-purple-100 mt-0.5">{tipoOficio.nombre}</p>
            </div>
          ...
          <div className="p-6 space-y-4 overflow-y-auto max-h-[calc(90vh-180px)]">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg border-2 border-dashed border-purple-300 text-purple-700 hover:bg-purple-50 transition-all font-semibold"
            >
