...
import { GestionTerminosAlertasWorldClass } from './GestionTerminosAlertasWorldClass'; // ✅ RF006 WORLD CLASS - Diseño actualizado
...
export function ControlDisciplinarioFull() {
  ...
  console.log('  ✓ GestionTerminosAlertasWorldClass');
