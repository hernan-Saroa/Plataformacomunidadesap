...
export function GestionProcesosProfesionalesCompleto() {
  ...
  const [showWizardAuto, setShowWizardAuto] = useState(false);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Modales */}
      <AnimatePresence>
        {showWizardAuto && procesoSeleccionado && (
          <WizardCrearAutoWorldClass
            proceso={{
              numeroProceso: procesoSeleccionado.numeroProceso,
              denunciado: {
                nombre: procesoSeleccionado.denunciado.nombre,
                tipoIdentificacion: 'CC',
                numeroIdentificacion: procesoSeleccionado.denunciado.cedula
              },
              denunciante: {
                nombre: 'Sistema',
                tipoIdentificacion: 'NIT',
                numeroIdentificacion: '899999999'
              },
              profesionalAsignado: {
                nombre: procesoSeleccionado.profesionalAsignado,
                tipoIdentificacion: 'CC',
                numeroIdentificacion: '0000000000'
              },
              etapaActual: procesoSeleccionado.etapaActual,
              cedula: procesoSeleccionado.denunciado.cedula,
              noticiaOrigen: procesoSeleccionado.noticiaOrigen
            }}
            onClose={() => setShowWizardAuto(false)}
            onCrearAuto={() => {
