...
export function TopBar({ 
  ...
  return (
    <div
      className="bg-white border-b border-[--esap-gray-200] 
        px-3 sm:px-4 md:px-6 lg:px-4 xl:px-6 2xl:px-8 
        py-2.5 sm:py-3 lg:py-2.5 xl:py-3 2xl:py-4 
        flex items-center justify-between sticky top-0 z-[101]"
      style={{ boxShadow: 'var(--esap-shadow-sm)' }}
    >
      <div className="flex items-center gap-2 sm:gap-3 lg:gap-2.5 xl:gap-3 2xl:gap-4 flex-1">
        {/* 📱 HAMBURGER BUTTON - Responsive */}
        <button
          onClick={onToggleSidebar}
          className="p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-all active:scale-95 touch-target-mobile"
