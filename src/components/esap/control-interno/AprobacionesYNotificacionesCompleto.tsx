...
const APROBACIONES_EJEMPLO: SolicitudAprobacion[] = [
  ...
  },
  {
    ...
    codigo: 'APR-2025-003',
    tipo: 'hallazgo',
    titulo: 'Validación Hallazgo - Inconsistencias Presupuestales',
    descripcion: 'Hallazgo de inconsistencias en ejecución presupuestal Q4',
    solicitante: 'Carlos Rodríguez',
    aprobador: 'Director Financiero',
    fechaSolicitud: '2025-01-18',
    fechaLimite: '2025-01-22',
    estado: 'devuelto',
    prioridad: 'media',
    documentoAsociado: 'HALL-2025-003',
    observaciones: 'Se requiere mayor detalle en causa raíz',
    fechaRespuesta: '2025-01-19',
    motivoRechazo: 'Ampliar análisis de causa raíz'
  },
  {
    id: 'apr-004',
    codigo: 'APR-2024-125',
    tipo: 'programa-auditoria',
    titulo: 'Aprobación Programa Anual Auditorías 2025',
    descripcion: 'Programa anual de auditorías para la vigencia 2025',
    ...
    estado: 'aprobado',
    prioridad: 'alta',
    documentoAsociado: 'PROG-ANUAL-2025',
    observaciones: 'Aprobado con observaciones menores',
    fechaRespuesta: '2024-12-18',
    motivoRechazo: null
  },
  {
    id: 'apr-005',
    codigo: 'APR-2024-118',
    tipo: 'documento',
    titulo: 'Aprobación Papeles de Trabajo Auditoría Académica',
    descripcion: 'Papeles de trabajo de auditoría de gestión académica',
    solicitante: 'Ana Patricia Martínez',
    aprobador: 'María González',
    fechaSolicitud: '2025-01-20',
    fechaLimite: '2025-01-22',
    estado: 'aprobado',
    prioridad: 'media',
    documentoAsociado: 'PT-AUD-2025-001-001',
    observaciones: 'Papeles de trabajo completos y bien documentados',
    fechaRespuesta: '2025-01-21',
    motivoRechazo: null
  },
  {
    id: 'apr-006',
    codigo: 'APR-2025-004',
    tipo: 'plan-mejoramiento',
    titulo: 'Aprobación Plan - Indicadores Gestión Académica',
    descripcion: 'Plan de mejoramiento para implementar seguimiento de indicadores académicos',
    solicitante: 'Director Académico',
    aprobador: 'Jefe OCI',
    fechaSolicitud: '2025-01-19',
    fechaLimite: '2025-01-26',
    estado: 'pendiente',
    prioridad: 'media',
    documentoAsociado: 'PLAN-2025-003',
    observaciones: 'Pendiente revisión técnica',
    fechaRespuesta: null,
    motivoRechazo: null
  },
  {
    ...
    codigo: 'APR-2025-005',
    tipo: 'informe',
    titulo: 'Aprobación Informe Pormenorizado Semestre 2',
    descripcion: 'Informe pormenorizado del estado del control interno - Segundo semestre 2024',
    solicitante: 'Jefe OCI',
    aprobador: 'Rector',
    ...
    estado: 'pendiente',
    prioridad: 'alta',
    documentoAsociado: 'INF-PORM-2024-S2',
    observaciones: 'Informe obligatorio Ley 1474',
    fechaRespuesta: null,
    motivoRechazo: null
  },
  {
    ...
    codigo: 'APR-2025-006',
    tipo: 'hallazgo',
    titulo: 'Validación Hallazgo - Respaldos Sistema Académico',
    descripcion: 'Hallazgo crítico sobre ausencia de respaldos del sistema académico',
    solicitante: 'Andrés Sánchez',
    aprobador: 'Director TI',
    fechaSolicitud: '2025-01-14',
    fechaLimite: '2025-01-21',
    estado: 'pendiente',
    prioridad: 'alta',
    documentoAsociado: 'HALL-2025-008',
  ...
  },
  {
    ...
    codigo: 'APR-2024-130',
    tipo: 'plan-mejoramiento',
    titulo: 'Aprobación Plan - Actualización TRD',
    descripcion: 'Plan para actualizar Tablas de Retención Documental',
    solicitante: 'Jefe Archivo',
    aprobador: 'Jefe OCI',
    fechaSolicitud: '2024-12-01',
    fechaLimite: '2024-12-08',
    estado: 'aprobado',
    prioridad: 'media',
    documentoAsociado: 'PLAN-2024-018',
    observaciones: 'Aprobado para ejecución inmediata',
    fechaRespuesta: '2024-12-05',
    motivoRechazo: null
  },
  {
    id: 'apr-010',
    codigo: 'APR-2025-007',
    tipo: 'documento',
    titulo: 'Aprobación Informe Auditoría de Contratación',
    descripcion: 'Informe final de auditoría de cumplimiento en contratación',
    solicitante: 'Andrea Ramírez',
    aprobador: 'Jefe OCI',
    fechaSolicitud: '2025-01-17',
    fechaLimite: '2025-01-24',
    estado: 'pendiente',
    prioridad: 'alta',
    documentoAsociado: 'INF-AUD-2024-018',
    observaciones: 'Contiene hallazgos de alto riesgo',
    fechaRespuesta: null,
    motivoRechazo: null
  },
  {
    ...
    codigo: 'APR-2024-122',
    tipo: 'hallazgo',
    titulo: 'Validación Hallazgo - Segregación Funciones Compras',
    descripcion: 'Hallazgo sobre falta de segregación de funciones en compras',
    solicitante: 'Andrea Ramírez',
    aprobador: 'Jefe Administrativo',
    fechaSolicitud: '2024-12-05',
    fechaLimite: '2024-12-12',
    estado: 'aprobado',
    prioridad: 'alta',
    documentoAsociado: 'HALL-2024-025',
    observaciones: 'Hallazgo validado por responsable de área',
    fechaRespuesta: '2024-12-10',
    motivoRechazo: null
  },
  {
    id: 'apr-012',
    codigo: 'APR-2025-008',
    tipo: 'plan-mejoramiento',
    titulo: 'Aprobación Plan - Mapa de Riesgos',
    descripcion: 'Plan para actualizar y mantener vigente el mapa de riesgos',
    solicitante: 'Jefe Planeación',
    aprobador: 'Jefe OCI',
    fechaSolicitud: '2025-01-08',
    fechaLimite: '2025-01-15',
    estado: 'aprobado',
    prioridad: 'media',
    documentoAsociado: 'PLAN-2025-004',
    observaciones: 'Aprobado, iniciar ejecución',
    fechaRespuesta: '2025-01-15',
    motivoRechazo: null
  },
  {
    id: 'apr-013',
    codigo: 'APR-2024-128',
    tipo: 'informe',
    titulo: 'Aprobación Informe Anual OCI 2024',
    ...
    estado: 'rechazado',
    prioridad: 'alta',
    documentoAsociado: 'INF-ANUAL-OCI-2024',
    observaciones: 'Se requiere incluir más métricas de gestión',
    fechaRespuesta: '2024-12-22',
    motivoRechazo: 'Falta incluir indicadores de eficiencia y análisis comparativo con vigencia anterior'
  }
];
...
const NOTIFICACIONES_EJEMPLO: Notificacion[] = [
  ...
  },
  {
    ...
    mensaje: 'El PLAN-2025-001 vence en 15 días (31 de marzo)',
    fecha: '2025-01-16 08:00',
    estado: 'leida',
    prioridad: 'media',
    origen: 'Sistema de Seguimiento',
    accion: 'Ver plan',
    enlace: '/planes/PLAN-2025-001'
  },
  {
    id: 'not-004',
    tipo: 'recordatorio',
    titulo: 'Reunión de seguimiento programada',
    mensaje: 'Reunión de seguimiento trimestral el 30 de enero a las 10:00 AM',
    fecha: '2025-01-20 16:00',
    estado: 'leida',
    prioridad: 'media',
    origen: 'Calendario OCI',
  ...
  },
  {
    id: 'not-005',
    tipo: 'info',
    titulo: 'Informe Pormenorizado publicado',
    mensaje: 'El Informe Pormenorizado II Semestre 2024 ha sido publicado',
    fecha: '2025-01-15 11:30',
    estado: 'leida',
    prioridad: 'baja',
    origen: 'Módulo de Informes',
    accion: 'Ver informe',
    enlace: '/informes/INF-PORT-2024'
  },
  {
    id: 'not-006',
    tipo: 'alerta',
    titulo: 'Nuevo hallazgo registrado',
    mensaje: 'Se registró el hallazgo HALL-2025-004 en proceso de contratación',
    fecha: '2025-01-20 10:15',
    estado: 'no-leida',
    prioridad: 'alta',
    origen: 'Módulo de Hallazgos',
    accion: 'Ver hallazgo',
    enlace: '/hallazgos/HALL-2025-004'
  },
  {
    id: 'not-007',
    tipo: 'recordatorio',
    titulo: 'Informe trimestral Q1 próximo',
    mensaje: 'Recuerde elaborar el informe trimestral Q1 2025 antes del 10 de abril',
    fecha: '2025-01-19 09:00',
    estado: 'archivada',
    prioridad: 'baja',
    origen: 'Sistema',
    accion: null,
  ...
  },
  {
    id: 'not-008',
    tipo: 'vencimiento',
    titulo: 'Acción de plan vencida',
    mensaje: 'La acción ACC-001-03 "Capacitación PQRS" ha vencido sin completarse',
    fecha: '2025-01-20 08:30',
    estado: 'no-leida',
    prioridad: 'alta',
    origen: 'Sistema de Seguimiento',
    accion: 'Ver acción',
    enlace: '/acciones/ACC-001-03'
  },
  {
    id: 'not-009',
    tipo: 'aprobacion',
    titulo: 'Solicitud de aprobación devuelta',
    mensaje: 'El Director Financiero devolvió la solicitud APR-2025-003 para correcciones',
    fecha: '2025-01-19 15:20',
    estado: 'leida',
    prioridad: 'alta',
    origen: 'Módulo de Aprobaciones',
    accion: 'Ver solicitud',
    enlace: '/aprobaciones/APR-2025-003'
  },
  {
    id: 'not-010',
    tipo: 'alerta',
    titulo: 'Plan de mejoramiento retrasado',
    mensaje: 'El PLAN-2024-020 tiene 15 días de retraso en su ejecución',
    fecha: '2025-01-18 10:00',
    estado: 'leida',
    prioridad: 'media',
    origen: 'Sistema de Seguimiento',
    accion: 'Ver plan',
    enlace: '/planes/PLAN-2024-020'
  },
  {
    id: 'not-011',
    tipo: 'info',
    titulo: 'Auditoría finalizada',
    mensaje: 'La auditoría AUD-2025-001 ha sido finalizada y el informe está disponible',
    fecha: '2025-01-17 16:45',
    estado: 'archivada',
    prioridad: 'baja',
    origen: 'Módulo de Auditorías',
    accion: 'Ver auditoría',
    enlace: '/auditorias/AUD-2025-001'
  },
  {
    id: 'not-012',
    tipo: 'recordatorio',
    titulo: 'Actualización de mapa de riesgos',
    mensaje: 'Recuerde actualizar el mapa de riesgos del primer trimestre 2025',
    fecha: '2025-01-21 07:00',
    estado: 'no-leida',
    prioridad: 'media',
    origen: 'Sistema',
    accion: 'Ir a riesgos',
  ...
  },
  {
    id: 'not-013',
    tipo: 'alerta',
    titulo: 'Hallazgo crítico detectado',
    mensaje: 'Hallazgo HALL-2025-008: Ausencia de respaldos del sistema académico',
    fecha: '2025-01-14 11:20',
    estado: 'leida',
    prioridad: 'alta',
    origen: 'Módulo de Hallazgos',
    accion: 'Ver hallazgo',
    enlace: '/hallazgos/HALL-2025-008'
  },
  {
    id: 'not-014',
    tipo: 'aprobacion',
    titulo: 'Plan de mejoramiento aprobado',
    mensaje: 'El plan PLAN-2025-004 ha sido aprobado y puede iniciar ejecución',
    fecha: '2025-01-15 14:00',
    estado: 'archivada',
    prioridad: 'media',
    origen: 'Módulo de Aprobaciones',
    accion: 'Ver plan',
    enlace: '/planes/PLAN-2025-004'
  },
  {
    id: 'not-015',
    tipo: 'vencimiento',
    titulo: 'Informe de ley próximo a vencer',
    mensaje: 'El Informe Pormenorizado debe presentarse antes del 31 de enero',
    fecha: '2025-01-13 09:00',
    estado: 'leida',
    prioridad: 'alta',
    origen: 'Sistema de Informes',
    accion: 'Ver informe',
    enlace: '/informes/INF-PORM-2024-S2'
  },
  {
    id: 'not-016',
    tipo: 'info',
    titulo: 'Nueva versión del sistema disponible',
    mensaje: 'Se ha actualizado el sistema SIGL a la versión 2.1 con mejoras en reportes',
    fecha: '2025-01-12 08:00',
    estado: 'archivada',
    prioridad: 'baja',
    origen: 'Sistema',
    accion: null,
  ...
  },
  {
    id: 'not-017',
    tipo: 'recordatorio',
    titulo: 'Reunión comité de control interno',
    mensaje: 'Comité de coordinación de control interno el 25 de enero a las 2:00 PM',
    fecha: '2025-01-21 12:00',
    estado: 'no-leida',
    prioridad: 'media',
    origen: 'Calendario OCI',
    accion: 'Ver calendario',
  ...
  },
  {
    id: 'not-018',
    tipo: 'alerta',
    titulo: 'Ente de control solicita información',
    mensaje: 'La Contraloría solicita información sobre auditorías de contratación 2024',
    fecha: '2025-01-16 10:30',
    estado: 'leida',
    prioridad: 'alta',
    origen: 'Entes de Control',
    accion: 'Ver solicitud',
    enlace: '/entes-control/SOL-2025-001'
  }
];
