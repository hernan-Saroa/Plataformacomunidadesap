    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="flex-1 overflow-x-auto p-6">
        <div 
          ...
          style={{
            flexWrap: 'nowrap',
            minWidth: typeof window !== 'undefined' && window.innerWidth >= 768 ? 'max-content' : undefined
          }}
        >
          {etapas.map((etapa) => {
            ...
            return (
              <div key={etapa.key} className="flex-shrink-0 w-80 flex flex-col" style={{ minWidth: '280px' }}>
                {/* Header de columna */}
