...
// ✅ ELIMINADO: import { MOCK_USERS_WITH_SEDES } from '@/data/mockUsersWithSedes';
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
const MOCK_USERS_WITH_SEDES: MockUser[] = [
  {
    id: '1',
