...
export function LandingPage({ onLoginClick, onNavigate }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50">
      ...
      <footer className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-[#0f172a] to-gray-900">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
            ...
            >
              <img src={esapLogoWhite} alt="ESAP" className="h-12 mb-6 hover:scale-105 transition-transform" />
              <p className="text-gray-400 mb-6 leading-relaxed text-lg">
                Transformando la educación pública en Colombia con tecnología de clase mundial.
              </p>

              {/* Social Media con efectos hover premium */}
              <div className="flex gap-3 mb-6">
                <motion.a 
                  href="#" 
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  whileTap={{ scale: 0.95 }}
                  className="w-12 h-12 bg-gradient-to-br from-gray-800 to-gray-700 hover:from-[#1e5da8] hover:to-[#2563eb] rounded-xl flex items-center justify-center transition-all duration-300 shadow-lg group"
                >
              ...
              <div className="flex flex-wrap gap-3">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/30 rounded-lg">
                  ...
                  <span className="text-green-400 text-sm font-semibold">Sistema Activo</span>
                </div>
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                  <Shield className="w-4 h-4 text-blue-400" />
                  <span className="text-blue-400 text-sm font-semibold">Certificación ONAC</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <h3 className="text-white font-black mb-6 flex items-center gap-2">
                <div className="w-1 h-6 bg-gradient-to-b from-[#1e5da8] to-[#2563eb] rounded-full" />
                Enlaces Rápidos
              </h3>
              <ul className="space-y-3">
                <li>
                  <a href="#nosotros" onClick={(e) => { e.preventDefault(); onNavigate('nosotros'); }} className="text-gray-400 hover:text-white transition-colors flex items-center gap-2 group">
                    <ChevronRight className="w-4 h-4 text-[#1e5da8] group-hover:translate-x-1 transition-transform" />
                    Sobre Nosotros
                  </a>
                </li>
                <li>
            ...
            >
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('vinculaciones'); }} className="text-gray-400 hover:text-white transition-colors flex items-center gap-2 group">
                    <ChevronRight className="w-4 h-4 text-[#1e5da8] group-hover:translate-x-1 transition-transform" />
                    Vinculaciones
                  </a>
                </li>
                <li>
                  <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('verificacion'); }} className="text-gray-400 hover:text-white transition-colors flex items-center gap-2 group">
                    <ChevronRight className="w-4 h-4 text-[#1e5da8] group-hover:translate-x-1 transition-transform" />
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 group">
                  <div className="w-10 h-10 bg-gradient-to-br from-[#1e5da8] to-[#2563eb] rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                    <MapPin className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <p className="text-gray-500 text-xs mb-1">Dirección</p>
                    <p className="text-gray-300 text-sm leading-relaxed">Calle 44 No. 53-37 CAN<br />Bogotá, Colombia</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 group">
                  <div className="w-10 h-10 bg-gradient-to-br from-[#1e5da8] to-[#2563eb] rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">+57 (1) 220 0700</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 group">
                  <div className="w-10 h-10 bg-gradient-to-br from-[#1e5da8] to-[#2563eb] rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">info@esap.edu.co</p>
                  </div>
                </li>
              </ul>
            </motion.div>
          ...
          >
            <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
              ...
              <div className="flex flex-wrap items-center justify-center gap-6">
                ...
                <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors flex items-center gap-2 group">
                  <Globe className="w-4 h-4 text-[#1e5da8]" />
                  Accesibilidad
                </a>
              </div>
            </div>
