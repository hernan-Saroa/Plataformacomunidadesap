-- ============================================================================
-- 044 · Estados del contrato hasta el cierre
--
...
--
-- Hasta aquí el ciclo llegaba a EJECUCION (041) porque era lo último que había
...
-- no cuánto avanzó.
--
-- En un DO por la misma razón que en la 036, la 037 y la 041: sin tabla de
-- control, la reaplicación tiene que converger en vez de fallar o retroceder.
-- Sin el guard, volver a aplicar la 041 después de esta borraría los cuatro
...
-- El CHECK de la 041 exige fecha de arranque a los contratos en ejecución. Los
