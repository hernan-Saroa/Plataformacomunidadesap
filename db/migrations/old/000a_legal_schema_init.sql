-- ============================================
-- Migration 000a: Legal Management Schema Init
-- Originally from db/init/01_legal_schema_init.sql
-- MUST run before other migrations that depend on legal_management schema
-- ============================================
