-- Actualiza las plantillas laborales que conservan exactamente el contenido
-- predeterminado anterior. Las plantillas personalizadas no se modifican.
BEGIN;
