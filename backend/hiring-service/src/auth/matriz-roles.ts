...
import {
  ROL_ADMINISTRADOR_CONTRATACION,
  ROL_APOYO_SUPERVISION,
  ROL_ARCHIVO_GESTION_DC,
  ROL_DIRECTOR_CONTRATACION,
  ROL_ENTE_DE_CONTROL,
  ROL_ESTRUCTURADOR_FINANCIERO,
  ROL_ESTRUCTURADOR_TECNICO,
...
export interface PermisoDelCatalogo {
  codigo: string;
  /** Cómo se llama en `auth.permission`; la migración 654 siembra el mismo. */
  nombre: string;
