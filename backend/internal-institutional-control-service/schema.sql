...
-- Encoding: UTF-8 (requerido para caracteres especiales en español)
-- ============================================

-- Asegurar que la base de datos use UTF-8
-- NOTA: Esto debe ejecutarse a nivel de base de datos antes de crear el schema
-- Ejemplo: CREATE DATABASE esap_db WITH ENCODING 'UTF8' LC_COLLATE='es_CO.UTF-8' LC_CTYPE='es_CO.UTF-8';
