 ...
 * cuando un PTA tiene asignaturas dictadas en 2+ Direcciones Territoriales
 * distintas (ej. Antioquia y Bolívar), cada una se aprueba/devuelve de forma
 * independiente. Ver assertAlcanceTerritorial y aprobarComponenteTerritorialParcial
 * en pta.service.ts.
 *
 * La fila única por componente en PtaComponentApproval sigue existiendo y se
 * consolida (aprobado) solo cuando TODAS las territoriales de esta tabla quedan
 * en 'aprobado'.
 */
