      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-2xl overflow-hidden my-6">
        ...
        <div className="px-6 py-4 bg-gradient-to-r from-red-700 via-rose-700 to-amber-700 text-white flex items-center justify-between">
          ...
          <button
            ...
            onClick={onClose}
            disabled={procesando}
            className="p-1.5 rounded-lg hover:bg-white/20 text-white/80 hover:text-white transition-colors disabled:opacity-50"
        ...
        {accionExitosa && (
          <div className="p-4 bg-emerald-50 border-b border-emerald-100 flex items-center gap-3 text-emerald-800 text-sm font-semibold animate-in fade-in">
        ...
        {error && (
          <div className="p-4 bg-red-50 border-b border-red-100 flex items-center gap-2 text-red-700 text-xs font-medium animate-in fade-in">
