...
const EMPTY_FORM = {
  ...
  address: '',
  city: '',
  // Paso 3 ΓÇö Datos Institucionales
  empresaContratista: '',
...
export function CreatePersonModal({
  ...
  const documentTypes = [
    ...
    { value: 'PPT', label: 'Permiso Protecci├│n Temporal' },
  ];
  ...
  const validateStep = (stepNumber: number): boolean => {
    ...
    if (stepNumber === 1) {
      ...
      if (!formData.documentNumber.trim()) newErrors.documentNumber = 'El n├║mero de documento es requerido';
    }
    ...
    // Paso 3: Datos Institucionales ΓÇö todos opcionales
            ...
            <AnimatePresence mode="wait">
                ...
                <motion.div key="step1" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }} transition={{ duration: 0.2 }} className="space-y-5">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input type="text" value={formData.lastName} onChange={(e) => handleChange('lastName', e.target.value)} className={inputCls(errors.lastName)} placeholder="Ej: P├⌐rez Mart├¡nez" />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className={labelCls}><FileText className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />N├║mero de Documento <span className="text-red-500">*</span></label>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className={labelCls}><UsersIcon className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />G├⌐nero</label>
              ...
              {step === 2 && (
                <motion.div key="step2" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }} transition={{ duration: 0.2 }} className="space-y-5">
                  <div>
                    <label className={labelCls}><Mail className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Correo Electr├│nico <span className="text-red-500">*</span></label>
                  ...
                  <div>
                    <label className={labelCls}><Phone className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Tel├⌐fono <span className="text-red-500">*</span></label>
                  ...
                  <div>
                    <label className={labelCls}><MapPin className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Direcci├│n</label>
                  ...
                  <div>
                    ...
                    <input type="text" value={formData.city} onChange={(e) => handleChange('city', e.target.value)} className={inputCls(errors.city)} placeholder="Ej: Bogot├í D.C." />
              ...
              {step === 3 && (
                <motion.div key="step3" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }} transition={{ duration: 0.2 }} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className={labelCls}><MapPin className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Ubicaci├│n F├¡sica</label>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" value={formData.nombreJefeDependencia} onChange={(e) => handleChange('nombreJefeDependencia', e.target.value)} className={inputCls()} placeholder="Ej: Mar├¡a Garc├¡a" />
                    </div>
                    <div>
                      <label className={labelCls}><Monitor className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Aplicaci├│n</label>
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest text-gray-400 flex items-center gap-2 pt-1">
                    <FileText className="w-3.5 h-3.5" /> Informaci├│n de Contrato
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className={labelCls}><Clock className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Tiempo de Contrato / Resoluci├│n</label>
              ...
              {step === 4 && (
                <motion.div key="step4" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }} transition={{ duration: 0.2 }} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className={labelCls}><UsersIcon className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Rol en la Instituci├│n <span className="text-red-500">*</span></label>
                  ...
                  {formData.role === 'Docente' && (
                    <>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className={labelCls}><Briefcase className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Tipo de Vinculaci├│n</label>
                          <select value={formData.tipoVinculacion} onChange={(e) => handleChange('tipoVinculacion', e.target.value)} className={selectCls()}>
                            <option value="">Seleccionar vinculaci├│n</option>
                            <option value="CARRERA">Carrera Docente</option>
                            <option value="OCASIONAL">Ocasional</option>
                            <option value="CATEDRA">Hora C├ítedra</option>
                            <option value="VISITANTE">Visitante</option>
                            <option value="ESPECIAL">Especial</option>
                          </select>
                        </div>
                        <div>
                          <label className={labelCls}><FileText className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Dedicaci├│n</label>
                          <select value={formData.dedicacion} onChange={(e) => handleChange('dedicacion', e.target.value)} className={selectCls()}>
                            <option value="">Seleccionar dedicaci├│n</option>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className={labelCls}><GraduationCap className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Escalaf├│n</label>
                          <select value={formData.escalafon} onChange={(e) => handleChange('escalafon', e.target.value)} className={selectCls()}>
                            <option value="">Seleccionar escalaf├│n</option>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          <label className={labelCls}><GraduationCap className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Nivel de Formaci├│n</label>
                          <input type="text" value={formData.nivelFormacion} onChange={(e) => handleChange('nivelFormacion', e.target.value)} className={inputCls()} placeholder="Ej: Maestr├¡a" />
                        </div>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className={labelCls}><GraduationCap className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Pregrado</label>
                          <input type="text" value={formData.pregradoDetalle} onChange={(e) => handleChange('pregradoDetalle', e.target.value)} className={inputCls()} placeholder="T├¡tulo de pregrado" />
                        </div>
                        <div>
                          <label className={labelCls}><GraduationCap className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Especializaci├│n</label>
                          <input type="text" value={formData.especializacionDetalle} onChange={(e) => handleChange('especializacionDetalle', e.target.value)} className={inputCls()} placeholder="Especializaci├│n" />
                        </div>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className={labelCls}><GraduationCap className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Maestr├¡a</label>
                          <input type="text" value={formData.maestriaDetalle} onChange={(e) => handleChange('maestriaDetalle', e.target.value)} className={inputCls()} placeholder="Maestr├¡a" />
                        </div>
                        <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className={labelCls}><Calendar className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Fecha Inicio Vinculaci├│n</label>
                        ...
                        <div>
                          <label className={labelCls}><Calendar className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />Fecha Fin Vinculaci├│n</label>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className={labelCls}><Tag className="w-4 h-4 inline-block mr-1.5 text-[#003DA5]" />├Ültima Evaluaci├│n</label>
            ...
            >
              {step === 1 ? 'Cancelar' : (
                <span className="flex items-center gap-2">
                  <ArrowLeft className="w-4 h-4" strokeWidth={2.5} /> Atr├ís
                </span>
              )}
            </button>
