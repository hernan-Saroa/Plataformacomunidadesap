              ...
              <div className="flex items-center gap-2 md:gap-2.5">
                <div className="relative group flex-shrink-0">
                  <Avatar className="w-12 h-12 md:w-14 md:h-14 ring-2 ring-white/40" style={{ width: '48px', height: '48px', borderRadius: '50%', flexShrink: 0 }}>
                    <AvatarFallback className="bg-white/20 backdrop-blur-md text-white text-base md:text-lg font-black" style={{ width: '100%', height: '100%', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      {userInitials}
                    </AvatarFallback>
                  </Avatar>
                </div>
