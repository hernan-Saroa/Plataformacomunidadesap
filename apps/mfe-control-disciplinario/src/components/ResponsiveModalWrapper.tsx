      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className={`fixed inset-0 ${isMobile ? 'bg-black' : 'bg-black/70 backdrop-blur-sm'}`}
            style={{ zIndex: 100001 }}
          />
      ...
      {isOpen && (
        <>
          <motion.div
            ...
            style={{ zIndex: 100001 }}
          />
          <div className="fixed inset-0 flex items-center justify-center p-4" style={{ zIndex: 100002 }}>
            <motion.div
