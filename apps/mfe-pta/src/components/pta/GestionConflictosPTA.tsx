  ...
  const data: Array<Omit<Conflicto, 'intervenciones'> & { intervenciones: Intervencion[] }> = [
    {
      ...
      programa: 'Adm. Pública', territorial: 'CUNDINAMARCA', periodo: '2025-2',
    ...
    },
    {
      ...
      programa: 'C. Políticas', territorial: 'ANTIOQUIA', periodo: '2025-2',
    ...
    },
    {
      ...
      programa: 'Economía Pública', territorial: 'VALLE DEL CAUCA', periodo: '2025-2',
    ...
    },
    {
      ...
      programa: 'Gestión Pública', territorial: 'ATLÁNTICO', periodo: '2025-2',
    ...
    },
    {
      ...
      programa: 'Adm. Pública', territorial: 'SANTANDER', periodo: '2025-2',
    ...
    },
    {
      ...
      programa: 'C. Políticas', territorial: 'BOLÍVAR', periodo: '2025-2',
